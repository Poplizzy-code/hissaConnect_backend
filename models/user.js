...
const userSchema = new mongoose.Schema(
  {
    firstName: { type: String, required: [true, 'Please provide a first name'], trim: true },
    ...
    matricNo: { type: String, required: [true, 'Please provide a matric number'], unique: true },
    currentLevel: { type: String, enum: ['100', '200', '300', '400'], required: true },
    role: { type: String, enum: ['student', 'moderator', 'instructor', 'admin'], default: 'student' },
