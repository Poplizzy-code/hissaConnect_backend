...
const { makeAdmin, removeAdmin, getAllUsers } = require('../controllers/admincontroller');
const { uploadResource, getResourcesByLevel, getAllResources, deleteResource } = require('../controllers/resourcecontroller');
...
router.post('/remove-admin/:userId', protect, authorize('admin'), removeAdmin);
router.get('/users', protect, authorize('admin'), getAllUsers);
router.post('/upload-resource', protect, authorize('admin'), uploadResource);
router.delete('/resources/:id', protect, authorize('admin'), deleteResource);
